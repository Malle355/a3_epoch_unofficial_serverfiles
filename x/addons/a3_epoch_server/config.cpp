...
requiredVersion = 0.1;
requiredAddons[] = {};
epochVersion = 0.1.0.3;
};
};

class CfgLootTable {
class Items {
items[] = {{"ItemCompass"},{"ItemCompass"},{"ItemCompass"},{"ItemGPS"},{"ItemMap"},{"ItemMap"},{"EpochRadio0"},{"ItemWatch"},{"FirstAidKit"},{"FirstAidKit"},{"FirstAidKit"}};
itemType = "item";
};
...
class SniperRifle {
items[] = {{"srifle_EBR_F"},{"srifle_EBR_F"},{"srifle_EBR_F"},{"srifle_EBR_F"},{"srifle_GM6_F"},{"srifle_LRR_F"},{"srifle_DMR_01_F"}};
itemType = "weapon";
};

class SniperRifleAmmo {
items[] = {{"20Rnd_762x51_Mag"},{"20Rnd_762x51_Mag"},{"20Rnd_762x51_Mag"},{"5Rnd_127x108_Mag"},{"5Rnd_127x108_APDS_Mag"},{"7Rnd_408_Mag"},{"10Rnd_762x51_Mag"},{"10Rnd_762x51_Mag"}};
itemType = "magazine";
};
...
class GenericBed {
items[] = {{"ItemDocument"},{"ItemMixOil"},{"emptyjar_epoch"},{"FoodBioMeat"},{"ItemSodaOrangeSherbet"},{"ItemSodaOrangeSherbet"},{"ItemSodaRbull"},{"ItemSodaRbull"},{"sardines_epoch"},{"meatballs_epoch"},{"scam_epoch"},{"sweetcorn_epoch"},{"Towelette"},{"Towelette"},{"Towelette"},{"Towelette"},{"Towelette"},{"HeatPack"},{"HeatPack"},{"ColdPack"},{"ColdPack"},{"VehicleRepair"},{"VehicleRepair"},{"ItemCorrugated"},{"ItemCorrugated"}};
itemType = "magazine";
};

class GenericLarge {
items[] = {{"MortarBucket"},{"ItemCorrugated"},{"ItemCorrugated"},{"CinderBlocks"},{"jerrycan_epoch"},{"VehicleRepair"}};
itemType = "magazine";
};
...
class RifleBoat {
items[] = {{"arifle_SDAR_F"},{"SMG_02_F"},{"SMG_01_F"},{"SMG_02_F"},{"hgun_PDW2000_F"},{"hgun_PDW2000_F"},{"Rollins_F"},{"speargun_epoch"}};
itemType = "weapon";
};
...
class PistolAmmo {
items[] = {{"16Rnd_9x21_Mag"},{"30Rnd_9x21_Mag"},{"9Rnd_45ACP_Mag"},{"11Rnd_45ACP_Mag"},{"6Rnd_45ACP_Cylinder"},{"10rnd_22X44_magazine"},{"16Rnd_9x21_Mag"},{"30Rnd_9x21_Mag"},{"9Rnd_45ACP_Mag"},{"11Rnd_45ACP_Mag"},{"6Rnd_45ACP_Cylinder"},{"10rnd_22X44_magazine"},{"6Rnd_GreenSignal_F"},{"6Rnd_RedSignal_F"},{"9rnd_45X88_magazine"},{"9rnd_45X88_magazine"},{"EnergyPack"},{"EnergyPack"},{"EnergyPack"}};
itemType = "item";
};

class Scopes {
items[] = {{"optic_Arco"},{"optic_Hamr"},{"optic_Aco"},{"optic_ACO_grn"},{"optic_Aco_smg"},{"optic_ACO_grn_smg"},{"optic_Holosight"},{"optic_Holosight_smg"},{"optic_SOS"},{"optic_MRCO"},{"optic_DMS"},{"optic_Yorris"},{"optic_MRD"},{"optic_LRPS"},{"optic_Arco"},{"optic_Arco"},{"optic_Hamr"},{"optic_Aco"},{"optic_ACO_grn"},{"optic_Aco_smg"},{"optic_ACO_grn_smg"},{"optic_Holosight"},{"optic_Holosight_smg"},{"optic_SOS"},{"optic_MRCO"},{"optic_MRCO"},{"optic_DMS"},{"optic_Yorris"},{"optic_MRD"},{"optic_LRPS"},{"optic_NVS"},{"optic_Nightstalker"}};
itemType = "item";
};
...
class Food {
items[] = {{"FoodBioMeat"},{"ItemSodaOrangeSherbet"},{"ItemSodaOrangeSherbet"},{"ItemSodaRbull"},{"ItemSodaRbull"},{"honey_epoch"},{"emptyjar_epoch"},{"sardines_epoch"},{"meatballs_epoch"},{"scam_epoch"},{"sweetcorn_epoch"},{"WhiskeyNoodle"}};
itemType = "magazine";
};
...
items[] = {{"ItemGoldBar"},{"ItemSilverBar"},{"ItemKiloHemp"},{"WhiskeyNoodle"},{"Pelt_EPOCH"},{"HandGrenade"},{"MiniGrenade"}};
itemType = "magazine";
};

class Epoch_Cloak_F {
items[] = {{"ItemTopaz"},{"ItemObsidian"},{"ItemSapphire"},{"ItemAmethyst"},{"ItemEmerald"},{"ItemCitrine"},{"ItemRuby"},{"HandGrenade"},{"MiniGrenade"},{"Venom_EPOCH"},{"Hatchet"},{"MeleeSledge"},{"ChainSaw"}};
itemType = "magazine";
};
...
class Explosives {
items[] = {{"HandGrenade"},{"MiniGrenade"},{"HandGrenade"},{"MiniGrenade"},{"HandGrenade"},{"MiniGrenade"},{"ATMine_Range_Mag"},{"APERSMine_Range_Mag"},{"APERSBoundingMine_Range_Mag"},{"SLAMDirectionalMine_Wire_Mag"},{"APERSTripMine_Wire_Mag"}};
itemType = "magazine";
};
